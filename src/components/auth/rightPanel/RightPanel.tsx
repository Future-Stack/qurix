  ...
  return (
    <div className="w-full h-full relative overflow-hidden flex flex-col justify-center min-h-screen">
      ...
      <div className="flex-1 flex flex-col justify-center relative py-10 lg:py-[89px] px-6 lg:px-[63px]">
        {/* Decorative background flower element */}
        ...
        {/* Login Card */}
        <div className="w-full max-w-md mx-auto bg-white border border-[#00AB0C36]  rounded-3xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] p-8 lg:p-10 relative z-10">
          {children}
        </div>
