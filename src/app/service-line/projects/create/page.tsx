    ...
    <div className="h-full max-w-full overflow-hidden m-4 mr-4">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-4">
          <button className="flex items-center gap-2 px-6 py-2.5 border border-[#E2E8F0] bg-white rounded-xl text-sm font-bold text-[#475569] hover:bg-gray-50 transition-colors shadow-sm">
            Cancel
          </button>
          <button className="flex items-center gap-2 px-6 py-2.5 bg-[#06530B] hover:bg-[#05290b] text-white rounded-xl text-sm font-bold transition-colors shadow-sm">
